...
types:
  ...
  custom_comp_data:
    seq:
      ...
      - id: static_states
        type: int_pairs
      - id: linked_word_sizes # unused in later iterations of this format
        type: int_pairs
  string_pair:
  ...
  assembler_info:
    seq:
      ...
      - id: watched_count
        type: u2
      - id: watched_components
        type: watched_component
        repeat: expr
        repeat-expr: watched_count
  component:
    ...
    seq:
      ...
      - id: assembler_info
        type: assembler_info
        if: component_kind == component_kinds::com_assembler or component_kind == component_kinds::com_probe_memory_bit or component_kind == component_kinds::com_imm_probe_memory_bit or component_kind == component_kinds::com_probe_memory_word or component_kind == component_kinds::com_static_value or component_kind == component_kinds::com_console or component_kind == component_kinds::com_pixel_screen
  components:
    seq:
      - id: length
        type: s8
